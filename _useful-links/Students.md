...
<tbody>
		<tr>
			<td style="border: solid 0px black"><a href="https://vle.learning.moe.edu.sg/login" target="_blank" style="font-weight:bold; font-size:18px; background-color: #4CAF50; color:white">Click ⇣here to login to SLS</a>
				<ul>
				...
				<li style="line-height:0.5; font-family:arial; font-size:16px"><a href="https://www.learning.moe.edu.sg/students/password-and-technical-support/" target="_blank">Technical Supports and Passwords</a></li>
