	...
	<tr>
		...
		<td>
			<ul style="margin:0px; list-style-type:none;">
				...
				<li style="line-height:2;"><a href="https://esms.stsynthesis.com/MOE/Default.aspx" target="_blank"><img src="/images/Icons/essmslogo.png" style="border:3px solid white; float:left;width:65px;height:35px;">ESSMS</a></li>
