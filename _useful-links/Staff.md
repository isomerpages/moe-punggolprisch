	...
	<tr>
		...
		<td>
			<ul style="margin:0px; list-style-type:none;">
				...
				<li style="line-height:2;"><a href="https://pps1742.edupage.org/" target="_blank"><img src="/images/Icons/edupage_icon.png" style="border:3px solid white; float:left;width:35px;height:35px">EduPage</a></li>
				...
				<li style="line-height:2;"><a href="https://ams.stlogs.com/AMSWeb/login" target="_blank"><img src="/images/Icons/stlog.png" style="border:3px solid white; float:left;width:35px;height:35px;">ST Enterprise Asset Mangement</a></li>
		...
		<td>
			<ul style="margin:0px;  list-style-type:none">
				...
				<li style="line-height:2;"><a href="https://sites.google.com/moe.edu.sg/pps-epedagogy-and-ict-tools-sh/school-cockpit-administrative-deadlines" target="_blank"><img src="/images/Icons/gsite_icon.png" style="border:3px solid white; float:left;width:35px;height:35px">ICT Microsite for Staff</a></li>
	...
	<tr>
		...
		<td><ul style="margin:0px; list-style-type:none; line-height:3">
			...
			<li style="line-height:2;"><a href="https://schoolcockpit.moe.gov.sg/" target="_blank"><img src="/images/Icons/SC.gif" style="border:3px solid white; float:left;width:65px;height:35px">School Cockpit</a></li>
				<li style="line-height:2;"><a href="https://adfs.schools.moe.edu.sg/" target="_blank"><img src="/images/Icons/SSOE2.png" style="border:3px solid white; float:left;width:65px;height:35px;">SSOE2 Service Portal</a></li>
