	...
	<tr>
		...
		<td>
			<ul style="margin:0px; list-style-type:none;">
				...
				<li style="line-height:2;"><a href="https://esms.stsynthesis.com/MOE/Default.aspx" target="_blank"><img src="/images/Icons/essms2.png" style="border:3px solid white; float:left;width:65px;height:25px;">ESSMS</a></li>
